...
<body>
    <div id="editor">
        ...
        <div class="wrapper-add-section">
            <div class="add-section">
                ...
                <button type="button" onclick="createImageSection(event)" class="btn btn-light rounded-circle m-1"><img src="{{ asset('pics/imgBox.svg') }}"></button>
                <button type="button" onclick="createMarkedSection(event)" class="btn btn-light rounded-circle m-1"><img src="{{ asset('pics/markdown.svg') }}"></button>
                <hr>
            </div>
        </div>
    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/marked/15.0.3/lib/marked.umd.min.js" integrity="sha512-Kt7350NAX8m05J2xcXWI1kAyZQjLm5c/yW0tz5qOpPyKhaidt+p5axcaL3TCaoYfJ11eHOO8nXKtXyGo+z5PMg==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>    <script src="{{ asset('js/posteditor.js') }}"></script>
